...
var DonutService = /** @class */ (function () {
    function DonutService(_http) {
        this._http = _http;
        this._donutUrl = 'assets/dados/DONUT_DIA.json';
    }
    DonutService.prototype.getDonut = function (id) {
        var getID = id;
    ...
    DonutService.prototype.handleError = function (error) {
        console.error(error);
...
//# sourceMappingURL=donut.service.js.map