...
var ErrosService = /** @class */ (function () {
    function ErrosService(_http) {
        this._http = _http;
        this._totaisUrl = 'assets/dados/TOTAIS_DIA.json';
    }
    ErrosService.prototype.getErros = function (id) {
        var getID = id;
    ...
    ErrosService.prototype.handleError = function (error) {
        console.error(error);
        return rxjs_1.throwError(error || 'Server error');
    };
    ErrosService = __decorate([
        core_1.Injectable(),
        __metadata("design:paramtypes", [http_1.HttpClient])
    ], ErrosService);
    return ErrosService;
}());
exports.ErrosService = ErrosService;
//# sourceMappingURL=erros.service.js.map