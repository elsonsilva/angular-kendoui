...
import { DonutAnoCenterService } from './donut-ano-center.service';

@Component({
  selector: 'app-donut-ano-center',
  templateUrl: './donut-ano-center.component.html',
  styleUrls: ['./donut-ano-center.component.scss']
})
export class DonutAnoCenterComponent implements OnInit, OnChanges, OnDestroy  {
  ...
  // constructor(sanitizer: DomSanitizer, private _donutCenterService: DonutCenterService) {
    constructor(sanitizer: DomSanitizer, private _donutAnoCenterService: DonutAnoCenterService) {
  ...
  ngOnInit(): void {
    ...
    this._donutAnoCenterService.getDonutCenter(this.idDonut)
    .pipe(
      first()
     )
