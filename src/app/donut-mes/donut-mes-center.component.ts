...
import { DonutMesCenterService } from './donut-mes-center.service';

@Component({
  selector: 'app-donut-mes-center',
  templateUrl: './donut-mes-center.component.html',
  styleUrls: ['./donut-mes-center.component.scss']
})
export class DonutMesCenterComponent implements OnInit, OnChanges, OnDestroy  {
  ...
  // constructor(sanitizer: DomSanitizer, private _donutCenterService: DonutCenterService) {
    constructor(sanitizer: DomSanitizer, private _donutMesCenterService: DonutMesCenterService) {
  ...
  ngOnInit(): void {
    ...
    this._donutMesCenterService.getDonutCenter(this.idDonut)
    .pipe(
      first()
     )
