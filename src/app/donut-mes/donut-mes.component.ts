...
import { DonutMesService } from './donut-mes.service';
@Component({
  selector: 'app-donut-mes',
  templateUrl: './donut-mes.component.html',
  styleUrls: ['./donut-mes.component.scss']
})
export class DonutMesComponent implements OnInit, OnChanges, OnDestroy {
  ...
  constructor(sanitizer: DomSanitizer, private _donutMesService: DonutMesService) {
  ...
  //  console.log('teste1: ' + this.idSelecionado);
    ...
    this._donutMesService.getDonut(this.id)
    .pipe(
      first()
     )
