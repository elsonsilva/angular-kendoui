...
import { DonutOntemService } from './donut-ontem.service';
@Component({
  selector: 'app-donut-ontem',
  templateUrl: './donut-ontem.component.html',
  styleUrls: ['./donut-ontem.component.scss']
})
export class DonutOntemComponent implements OnInit, OnChanges, OnDestroy {
  ...
  constructor(sanitizer: DomSanitizer, private _donutOntemService: DonutOntemService) {
