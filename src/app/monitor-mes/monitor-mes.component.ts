...
@Component({
  selector: 'app-monitor-mes',
  templateUrl: './monitor-mes.component.html',
  styleUrls: ['./monitor-mes.component.scss']
})
export class MonitorMesComponent implements OnInit {
  ...
  openDialog(): void {
    ...
    let dialogRef = this.dialog.open(DialogSettingsComponentMes, {
      // height: '250px',
      width: '450px'
    ...
    IntervalObservable.create(10000)
      ...
      //    console.log('index: ' + index);
        ...
        if (this._alternadorservice.retorna1()) {
          this._alternadorservice.capturaI(index);
          this.router.navigate(['monitor-ano']);
          this.alive = false;
            } 
...
@Component({
  selector: 'dialog-settings-component-mes',
  templateUrl: 'dialog-settings-component.html',
})
export class DialogSettingsComponentMes {
  ...
  constructor(
    public dialogRef: MatDialogRef<DialogSettingsComponentMes>,
    private router: Router,
    public _alternadorservice: AlternadorService,
