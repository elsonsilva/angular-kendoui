...
export class TopErrosService {
    ...
    getDia(): Observable<ITop[]> {
        // console.log('teste: ' + getID);
        return this._http.get<ITop[]>(this._diaUrl)
            // .retry(3)
            .pipe(
    ...
    getMes(): Observable<ITop[]> {
        // console.log('teste: ' + getID);
        return this._http.get<ITop[]>(this._mesUrl)
            // .retry(3)
            .pipe(
                map(data => data) // or any other operator
            );
